...
'] || 0)
		...
		estimatedFutureFee = Number(lowestPrimePriceCrenstone) + Number(reorderItems[key]['crenstone']['expected-future-fulfillment-fee-per-unit']) || Number(reorderItems[key]['oredroc']['expected-future-fulfillment-fee-per-unit']) || 0)
