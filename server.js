...
(function() {
  var Busboy, LocalStrategy, Q, _, apiworker, app, bcrypt, bodyParser, buildReorderData, compression, config, csrf, db, express, flash, getFileWithLength, outputReorderColumns, parseAndStoreManualInputs, passport, removeFeeDataDuplicates, session, sortInventoryDataByAsin, toArray, upsertIntoDb, xlsx;
  ...
  buildReorderData = function(reorderItems) {
    ...
    db.sequelize.query(selectQuery, {
      ...
      var currentIndex, j, k, lastReorderIndex, len1, len2, manualInputAsin, manualInputsByAsin, numDuplicates, ref1, reorderDataByAsin, reorderDataCopy, reorderIndex, reorderIndices, row;
