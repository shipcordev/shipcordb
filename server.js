...
(function() {
  ...
  buildReorderData = function(reorderItems) {
    ...
    db.sequelize.query(selectQuery, {
      ...
      var j, k, l, len1, len2, len3, manualInput, manualInputAsin, manualInputsByAsin, newReorderRows, ref1, ref2, row;
      newReorderRows = [];
      if (manualInputs.length > 0) {
        ...
        for (j = 0, len1 = ref1.length; j < len1; j++) {
          ...
          for (k = 0, len2 = ref2.length; k < len2; k++) {
            ...
            if (row === -1) {
              reorderRow = ['', manualInput['asin'], '', '', '', '', '', '', '', '', '', '', manualInput['remove-from-restock-report'], '', '', '', '', '', '', '', '', '', '', manualInput['seasonal-tags'], manualInput['oem-mfg-part-number'], manualInput['oem-mfg'], manualInput['vendor-part-number'], manualInput['item-description'], manualInput['vendor-name'], manualInput['vendor-price'], manualInput['quantity-needed-per-asin'], '', '', '', manualInput['closeout-retail-tag'], manualInput['can-order-again'], '', '', '', '', '', '', '', '', '', '', '', '', manualInput['estimated-shipping-cost'], '', manualInput['overhead-rate'], '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', manualInput['estimated-shipping-cost'], '', manualInput['overhead-rate'], '', '', '', '', '', '', '', ''];
